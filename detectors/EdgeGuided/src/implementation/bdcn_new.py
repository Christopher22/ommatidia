...
class BDCN(nn.Module):
    ...
    def forward(self, x):
        ...
        sum1 = self.conv1_1_down(self.msblock1_1(features[0])) + self.conv1_2_down(
            self.msblock1_2(features[1])
        )
        s1 = self.score_dsn1(sum1)
        s11 = self.score_dsn1_1(sum1)
        # print(s1.data.shape, s11.data.shape)
        sum2 = self.conv2_1_down(self.msblock2_1(features[2])) + self.conv2_2_down(
            self.msblock2_2(features[3])
        )
        ...
        s21 = crop(s21, x, 1, 1)
        sum3 = (
            self.conv3_1_down(self.msblock3_1(features[4]))
        ...
        s31 = crop(s31, x, 2, 2)
        sum4 = (
            self.conv4_1_down(self.msblock4_1(features[7]))
        ...
        s41 = crop(s41, x, 4, 4)
        sum5 = (
            self.conv5_1_down(self.msblock5_1(features[10]))
        ...
        p1_1 = torch.sigmoid(p1_1)
        p2_1 = torch.sigmoid(p2_1)
        p3_1 = torch.sigmoid(p3_1)
        p4_1 = torch.sigmoid(p4_1)
        p5_1 = torch.sigmoid(p5_1)
        p1_2 = torch.sigmoid(p1_2)
        p2_2 = torch.sigmoid(p2_2)
        p3_2 = torch.sigmoid(p3_2)
        p4_2 = torch.sigmoid(p4_2)
        p5_2 = torch.sigmoid(p5_2)
